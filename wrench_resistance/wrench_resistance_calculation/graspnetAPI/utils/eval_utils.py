...
def get_grasp_score(grasp, obj, fc_list, force_closure_quality_config):
    ...
    #testing whether the grasp is qualified for every possible friction_coef. find its bound.
    for ind_, value_fc in enumerate(fc_list): #fc is the abbreviation of friction coefficient.
