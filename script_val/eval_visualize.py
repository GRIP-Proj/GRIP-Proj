...
for uuid in os.listdir(graspGen_dataset_path):
    ...
    for key in grasp.keys():
        ...
        # vis.add_geometry(contact_point)
        ...
        # plt.imsave(f'output_{uuid}_{key}.png', np.asarray(image))
        
        # from IPython import embed; embed()
        o3d.visualization.draw_geometries([pcd, contact_point, gripper, gt_gripper])
        break
